                ...
                <form action="">
                    <div class="footer-form-input">
                        ...
                        <div class="footer-form-input-contact">
                            <input type="text" placeholder="Ваш телефон" class="footer-form-input-tel">
        ...
        <div class="footer__list">
            ...
            <div class="footer__list-menu">
                ...
                <div class="footer__list-items">
                    ...
                    <a href="" class="footer__list-item">Мероприятия</a>
                    <a href="" class="footer__list-item">Новости</a>
                    <a href="" class="footer__list-item">База знаний</a>
                    <a href="" class="footer__list-item">Карьера</a>
                    <a href="" class="footer__list-item">Контакты</a>
                </div>
            </div>
